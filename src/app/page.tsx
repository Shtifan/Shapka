                        ...
                        <div className="p-6 bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200 transform transition-all hover:scale-[1.02] flex flex-col">
                            ...
                            <ol className="list-decimal list-inside space-y-2 text-gray-800 flex-grow">
                                <li className="p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                    Form teams of at least <strong className="text-blue-700">2 players</strong> each (minimum
                                    2 teams)
                                </li>
                                <li className="p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                ...
                                <li className="p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                    <strong className="text-blue-700">Round 1:</strong> Describe the word to your teammate
                                    without saying the word itself (60 seconds per team)
                                </li>
                                <li className="p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                    <strong className="text-blue-700">Round 2:</strong> Describe the word using only ONE word
                                    (60 seconds per team)
                                </li>
                                <li className="p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                                    <strong className="text-blue-700">Round 3:</strong> Draw the word for your teammate to
                                    guess (60 seconds per team)
                                </li>
                                <li className="p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
