      ...
      return (
        <div className="text-center p-3 bg-gray-50 rounded-lg border border-gray-200">
          ...
          <p className="text-gray-700 text-xs">
            {isMyTurn ? "It's your turn!" : `${currentPlayer?.name} from ${currentTeam?.name} is currently playing`}
          </p>
  ...
  const renderDrawingCanvas = () => {
    ...
    return (
      <div className="mt-2 flex flex-col items-center">
        ...
        {isMyTurn && (
          <p className="text-gray-600 mt-1 text-xs">Draw using your mouse</p>
        )}
      </div>
    );
  };
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 bg-white/90 backdrop-blur-sm rounded-lg shadow-lg border border-gray-200 h-[80vh] max-h-[600px] flex flex-col">
      ...
      <div className="flex justify-center mb-2">
        <div className={`text-center py-1 px-4 rounded-full text-sm ${timeLeft <= 10 ? 'bg-red-100 text-red-800 animate-pulse' : 'bg-blue-100 text-blue-800'}`}>
